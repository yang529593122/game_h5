...
export class show_model {
    constructor(option = {}) {
        ...
        let model_tit = option.title || global.i18n['温馨提示'];
        let model_concent = option.content.substr(0, 36) || global.i18n["请输入内容~"]
        let clickEvent = option.IsclickEvent || false;
        let cancelVal = option.cancelText || global.i18n['取消'];
        let confirmVal = option.confirmText || global.i18n['确认'];
