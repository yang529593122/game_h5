	...
	<view class="onlineAccountPage">
		...
		<view class="onlineAccountPageBottom">
			<view class="onlineAccountPageBottomContent" v-if="isEdit === 0">
				...
				<!-- <view ></view> -->
				<button type="default" class="onlineAccountPageBottomContentRight" :loading="confirmPayLoading" @click="confirmPay">确认支付</button>
			</view>
...
<script>
	...
	export default {
		...
		methods:{
			...
			// 确认支付
			confirmPay() {
				this.gameonlineestimationaccount();
				// this.confirmPayLoading = true;
