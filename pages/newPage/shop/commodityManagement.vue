	...
	<view class="content">
		<view class="tab-list">
			...
			<view class="tab-item" @click="getTab(3)" :class="{active:active==3}">
				审核失败<span v-if="active==3"></span>
			</view>
			<view class="tab-item" @click="getTab(4)" :class="{active:active==4}">
				出售中<span v-if="active==4"></span>
			</view>
			<view class="tab-item" @click="getTab(5)" :class="{active:active==5}">
				已下架<span v-if="active==5"></span>
			</view>
		</view>
		...
		<view class="shop-list">
			<view class="shop-item" v-for="item in 10" :key="item">
				...
				<view class="btns">
					<button class="btns1">删除</button>
					<button class="btns2">失败原因</button>
					<button class="btns3">编辑商品</button>
				</view>
			</view>
		</view>
	</view>
